...
const slides:Slide[]=[
 {k:"01",type:"DRUB / SHOWREEL",title:"WE MAKE\nPEOPLE STOP.",sub:"Experiential. Creators. Production.",media:"https://raw.githubusercontent.com/Armirocxiz/drub-media-website/main/public/media/drub-brand.mp4",fit:"portrait",cta:"Enter Drub",href:"#"},
 {k:"02",type:"BEAUTY / EXPERIENTIAL",title:"PUT THE\nBRAND IN IT.",sub:"Live brand moments designed to become content.",media:"https://raw.githubusercontent.com/Armirocxiz/drub-media-website/main/public/media/beauty.mp4",cta:"Create an experience",href:"mailto:reachus@drubme.com"},
 {k:"03",type:"EVENT / BEAUTYWORLD",title:"BE WHERE\nIT HAPPENS.",sub:"On-ground energy captured for the feed.",media:"https://raw.githubusercontent.com/Armirocxiz/drub-media-website/main/public/media/damas-rose.mp4",fit:"portrait",cta:"Start a project",href:"mailto:reachus@drubme.com"},
 {k:"04",type:"AI / PRODUCT FILM",title:"BUILD A\nNEW WORLD.",sub:"Creative technology turns products into stories without physical limits.",media:"https://raw.githubusercontent.com/Armirocxiz/drub-media-website/main/public/media/aged-infusion.mp4",cta:"Create with us",href:"mailto:reachus@drubme.com"},
 {k:"05",type:"3D / CGI / PRODUCT",title:"MAKE IT\nUNREAL.",sub:"Product films, 3D and CGI built to hold attention.",media:"https://raw.githubusercontent.com/Armirocxiz/drub-media-website/main/public/media/euphoria.mp4",cta:"Start a production",href:"mailto:reachus@drubme.com"},
 {k:"06",type:"EVENTS / PRODUCTION",title:"MAKE THE\nROOM FEEL IT.",sub:"Atmosphere, people and moments — captured with intent.",media:"https://raw.githubusercontent.com/Armirocxiz/drub-media-website/main/public/media/dinner.mp4",cta:"Talk to Drub",href:"mailto:reachus@drubme.com"},{k:"07",type:"DRUB TALENT NETWORK / LIVE",title:"FIND THE\nRIGHT FACE.",sub:"Creators. Models. Hostesses. Discover and shortlist UAE talent.",talent:true,cta:"Access Talent Network",href:talent}
];
...
<div className={"visual "+(s.talent?"talentVisual":"")}>{s.media?<video className={"reelVideo "+(s.fit==="portrait"?"portrait":"")} src={s.media} autoPlay muted loop playsInline preload="auto" onLoadedData={e=>{const v=e.currentTarget;v.muted=true;v.play().catch(()=>{})}}/>:<><div className="mesh"/><div className="object"><span>{s.k}</span></div><div className="scan"/></>}<div className="shade"/></div>
